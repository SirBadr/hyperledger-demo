...
./network.sh deployCC -ccn tokenERC721 -ccv 1 -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH}
# ./network.sh deployCC -ccn healthRecord -ccv 1 -cci initLedger -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH}
